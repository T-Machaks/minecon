...
// DynamoDB tables live in af-south-1
const ddb = DynamoDBDocumentClient.from(
  new DynamoDBClient({ region: 'af-south-1' }),
  { marshallOptions: { removeUndefinedValues: true } }
);

// Extract query/path params from Bedrock action event
...
// Extract request body properties from Bedrock action event
...
// Build the Bedrock response envelope
